...
export function Water() {
  ...
  useFrame((state) => {
    ...
    // Animate ripple via emissive intensity oscillation; cheap and theme-aware.
    mat.emissiveIntensity = (0.18 + Math.sin(t * 0.8) * 0.04) * params.waterLevel;

    mesh.scale.x = 0.2 + 0.8 * params.waterLevel;
